...
function Project() {
  return (
    ...
    <div className='block border-b border-gray-200 py-4 text-sm mx-2'>
            ...
            <div className='block md:flex mx-2 text-gray-600 relative my-3 bg-gray-100 px-2 py-2 md:py-4 pr-5 md:pr-20 rounded-xl ml-0 md:ml-5 mr-0 md:mr-2'>
              ...
              <div className=' block'>
                ...
                <div className='block max-w-lg py-2'>
            ...
            <div className='block md:flex mx-2 text-gray-600 relative my-3 bg-gray-100 px-2 py-2 md:py-4 pr-5 md:pr-20 rounded-xl ml-0 md:ml-5 mr-0 md:mr-2'>
              <img src={eccomerce} alt='eccomerce' className=' w-12 h-12 ml-4 my-2 md:my-0 mr-5 rounded-full' />
              <div className=' block'>
                <h1 className='font-semibold mb-2 text-sm md:text-base ml-3 text-black'>E-commerceBoost</h1>
                <div className='grid grid-cols-2 md:flex font-normal mb-2 ml-1 md:ml-0'>
                  <div className='flex font-normal text-xs'>
                  <i class="fa-regular fa-folder-closed relative top-1 mr-2"></i>
                  ...
                  <div className='flex  text-xs mt-2 md:mt-0'>
                  <i class="fa-solid fa-calendar-day relative top-1 mr-2"></i>
                  <p className='mr-0 md:mr-10'>Dec 2022</p>
                  </div>
                </div>
                <div className='block max-w-lg py-2'>
                  <p className='mb-3 mt-2'>E-commerceBoost is a full-stack solution for online retailers, offering seamless inventory management, secure payment gateways, and a user-friendly shopping experience.</p>
                </div>
                <div className='mb-5'>
            ...
            <div className='block md:flex mx-2 text-gray-600 relative my-3 bg-gray-100 px-2 py-2 md:py-4 pr-5 md:pr-20 rounded-xl ml-0 md:ml-5 mr-0 md:mr-2'>
              <img src={cloud} alt='cloud' className=' w-12 h-12 ml-4 my-2 md:my-0 mr-5 rounded-full' />
              <div className=' block'>
                <h1 className='font-semibold mb-2 text-sm md:text-base ml-3 text-black'>CloudSnip</h1>
                <div className='grid grid-cols-2 md:flex font-normal mb-2 ml-1 md:ml-0'>
                  <div className='flex font-normal text-xs'>
                  <i class="fa-regular fa-folder-closed relative top-1 mr-2"></i>
                ...
                <div className='block max-w-lg py-2'>
                  <p className='mb-3 mt-2'>CloudSnip is a versatile cloud storage service, providing users with secure file storage, sharing, and synchronization across devices. Experience the next level of cloud convenience.</p>
                </div>
                <div className='mb-5'>
            ...
            <div className='block md:flex mx-2 text-gray-600 relative my-3 bg-gray-100 px-2 py-2 md:py-4 pr-5 md:pr-20 rounded-xl ml-0 md:ml-5 mr-0 md:mr-2'>
              <img src={health} alt='health' className='w-12 h-12 ml-4 my-2 md:my-0 mr-5 rounded-full' />
              <div className=' block'>
                <h1 className=' font-semibold mb-2 text-sm md:text-base ml-3 text-black'>HealthTrackr</h1>
                <div className='grid grid-cols-2 md:flex font-normal mb-2 ml-1 md:ml-0'>
                  <div className='flex font-normal text-xs'>
