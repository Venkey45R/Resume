  ...
  return (
    ...
    <div className='block border-b border-gray-200 py-4 text-sm flex-grow'>
            <div className='flex fixed-navbar bg-white h-14 -ml-60 -mt-4 rounded-xl'>
              ...
              <div className='mx-8 flex justify-center items-center'>
                <Link to={`/project`}>
                <button  className=' hover:bg-gray-200 bg-white py-3 rounded-xl px-14 font-semibold text-gray-700 hover:text-blue-700'>Projects</button>
                </Link>
              </div>  
              <div className='mx-8 flex justify-center items-center'>
              <Link to={`/blog`}>
                <button className='bg-gray-200 px-16 rounded-xl py-3 text-blue-700 font-semibold'>Blog</button>
                </Link>
              </div>
            </div>
            </div>
